...
if (typeof window === 'object' && location.protocol === "http:" && !window.opera && (/\bMSIE\b/.test(navigator.userAgent))) {
    Deferred.next_faster_way_readystatechange = function (fun) {
        var d = new Deferred();
...
if (((typeof window === 'object') && (typeof(Image) != "undefined") && !window.opera && document.addEventListener)) {
...
Deferred.next = Deferred.next_faster_way_readystatechange || Deferred.next_faster_way_Image || Deferred.next_default;
...
Deferred.define = function (obj, list) {
    list = list || ["parallel", "wait", "next", "call", "loop", "repeat", "chain"];
    obj = obj || window;
    var name;
    for (var i = 0; i < list.length; i++) {
        name = list[i];
        obj[name] = Deferred[name];
    }
    return Deferred;
};
